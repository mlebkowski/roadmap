...
use Roadmap\Model\Session;
use Roadmap\Model\SessionQuery;
...
class SessionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Roadmap.Model.Map.SessionTableMap';
     ...
     */
    const OM_CLASS = '\\Roadmap\\Model\\Session';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Roadmap.Model.Session';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Data', 'CreatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'data', 'createdAt', ),
        self::TYPE_COLNAME       => array(SessionTableMap::ID, SessionTableMap::DATA, SessionTableMap::CREATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'DATA', 'CREATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'data', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Data' => 1, 'CreatedAt' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'data' => 1, 'createdAt' => 2, ),
        self::TYPE_COLNAME       => array(SessionTableMap::ID => 0, SessionTableMap::DATA => 1, SessionTableMap::CREATED_AT => 2, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'DATA' => 1, 'CREATED_AT' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'data' => 1, 'created_at' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Roadmap\\Model\\Session');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SessionTableMap::ID);
            $criteria->addSelectColumn(SessionTableMap::DATA);
            $criteria->addSelectColumn(SessionTableMap::CREATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Roadmap\Model\Session) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(SessionTableMap::DATABASE_NAME);
            $criteria->add(SessionTableMap::ID, (array) $values, Criteria::IN);
        }
