...
abstract class UserV2momVersion implements ActiveRecordInterface
{
    ...
    public function setValues($v)
    {
        ...
        if ($this->vals !== $v) {
            $this->vals = $v;
            $this->modifiedColumns[] = UserV2momVersionTableMap::VALS;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserV2momVersionTableMap::VALS)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getValues(),
            $keys[5] => $this->getMethods(),
            $keys[6] => $this->getObstacles(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setValues($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setMethods($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setObstacles($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserV2momVersionTableMap::VALS)) $criteria->add(UserV2momVersionTableMap::VALS, $this->vals);
