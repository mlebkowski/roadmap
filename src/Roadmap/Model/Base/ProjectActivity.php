...
abstract class ProjectActivity implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Roadmap\\Model\\Map\\ProjectActivityTableMap';
    ...
    /**
     * Initializes internal state of Roadmap\Model\Base\ProjectActivity object.
     */
    ...
    /**
     * Compares this with another <code>ProjectActivity</code> instance.  If
     * <code>obj</code> is an instance of <code>ProjectActivity</code>, delegates to
     * <code>equals(ProjectActivity)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ProjectActivity The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ProjectActivityTableMap::ID;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[] = ProjectActivityTableMap::PROJECT_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = ProjectActivityTableMap::USER_ID;
        }
    ...
    public function setActivityType($v)
    {
        ...
        if ($this->activity_type !== $v) {
            ...
            $this->modifiedColumns[] = ProjectActivityTableMap::ACTIVITY_TYPE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[] = ProjectActivityTableMap::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProjectActivityTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProjectActivityTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProjectActivityTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProjectActivityTableMap::translateFieldName('ActivityType', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProjectActivityQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProjectActivity::setDeleted()
     * @see ProjectActivity::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildProjectActivityQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectActivityTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProjectActivityTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ProjectActivityTableMap::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PROJECT_ID';
        }
        if ($this->isColumnModified(ProjectActivityTableMap::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(ProjectActivityTableMap::ACTIVITY_TYPE)) {
    ...
    {
        $pos = ProjectActivityTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = ProjectActivityTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectActivityTableMap::ID)) $criteria->add(ProjectActivityTableMap::ID, $this->id);
        if ($this->isColumnModified(ProjectActivityTableMap::PROJECT_ID)) $criteria->add(ProjectActivityTableMap::PROJECT_ID, $this->project_id);
    ...
    {
        $criteria = new Criteria(ProjectActivityTableMap::DATABASE_NAME);
        $criteria->add(ProjectActivityTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Roadmap\Model\ProjectActivity (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Roadmap\Model\ProjectActivity Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addProjectActivities($this);
             */
        }
    ...
    public function getProject(ConnectionInterface $con = null)
    {
        if ($this->aProject === null && ($this->project_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProject->addProjectActivities($this);
             */
        }
