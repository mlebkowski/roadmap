...
abstract class Session implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Roadmap\\Model\\Map\\SessionTableMap';
    ...
    /**
     * Initializes internal state of Roadmap\Model\Base\Session object.
     */
     ...
     * @return   \Roadmap\Model\Session The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SessionTableMap::ID;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[] = SessionTableMap::DATA;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== $v) {
            $this->created_at = $v;
            $this->modifiedColumns[] = SessionTableMap::CREATED_AT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SessionTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException("Error populating \Roadmap\Model\Session object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SessionTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SessionTableMap::DATA)) {
            $modifiedColumns[':p' . $index++]  = 'DATA';
        }
        if ($this->isColumnModified(SessionTableMap::CREATED_AT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionTableMap::ID)) $criteria->add(SessionTableMap::ID, $this->id);
        if ($this->isColumnModified(SessionTableMap::DATA)) $criteria->add(SessionTableMap::DATA, $this->data);
        if ($this->isColumnModified(SessionTableMap::CREATED_AT)) $criteria->add(SessionTableMap::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(SessionTableMap::DATABASE_NAME);
        $criteria->add(SessionTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Roadmap\Model\Session (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Roadmap\Model\Session Clone of current object.
     * @throws PropelException
     */
